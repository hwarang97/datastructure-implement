...
int moveMaxToFront(ListNode **ptrHead)
{
	...
	// find node with max value and max_prev_node
	while (current != NULL)
	{
		if (max_node == NULL)
		{
	...
	// LinkedList has only one node or
	// first node is the node with max value
